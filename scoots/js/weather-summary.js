const apiURL = "https://api.openweathermap.org/data/2.5/forecast?id=3530103&units=imperial&appid=dd504892e20d342c74bd24c89e54dc9a"
...
fetch(apiURL)
    ...
    .then((jsObject) => {
        ...
        document.getElementById('feels-like').textContent = jsObject.list[0].main.temp;
